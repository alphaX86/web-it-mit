...
<html lang="en">
    ...
    <head>
        <!-- Title -->
        <title>Virtuoso , Departmental Magazine - Department Of Information Technology</title>
        <!-- Meta -->
        <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        <meta name="description" content="Virtuoso the departmental magazine of Information Technology , Madras Institue Of Technology ,Anna University">
            ...
            <div id="content">
                <div class="container background-white">
                    <div class="row margin-vert-30">
                        <!-- Main Column -->
                        <div class="col-md-12">
                            <h2 style="color:#00695c; font-size:25pt;">Virtuoso - The Departmental Magazine</h2>
...
<tr>
                                  <td>3</td>
                                  <td>Samhita 19 Edition</td>
                                  <td>01/02/2019</td>
                                 
                                  
                                  <td><!--<a href="https://virtuoso.ml/archive/1/" target="_blank">E-Magazine</a> |--> <a href="../assets/magazine/virtuoso3.pdf">PDF</a></td>
                                </tr>

                                <tr>
                                  <td>2</td>
                                  <td>Mutex 18 Edition</td>
                                  <td>18/09/2018</td>
                                                                    
                                  <td><a href="https://virtuoso.ml/" target="_blank">E-Magazine</a> | <a href="../assets/magazine/virtuoso2.pdf">PDF</a></td>
                                </tr>
                                <tr>
                                  <td>1</td>
                                  <td>Samhita 18 Edition</td>
                                  <td>16/02/2018</td>
                                 
                                  
                                  <td><a href="https://virtuoso.it.mitindia.edu" target="_blank">E-Magazine</a> | </td>
                                </tr>
