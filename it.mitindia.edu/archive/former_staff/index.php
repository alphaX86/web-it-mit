...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description" content="<?php echo $row['NAME']; ?>,<?php echo $row['DESIGNATION']; ?> ,Fomer Staff , Department of Information Technology , Madras Institue Of Technology ,Anna University">
                            ...
                            <div class="row inc">
                                <?php
                                  ...
                                  echo "<div class=\"pad col-md-6 animate fadeIn\"><img class='img' src=\"../../assets/img/pics/".$en.".jpg\" alt=".$row["NAME"]." class=\"margin-top-10\"></div><div class=\"col-md-6 margin-bottom-10 animate fadeInRight\">";                                 
                                    ...
                                    if($en=="ITF01")                              
                                      echo "<h3 class=\"padding-top-10 pull-left\">Dr.B.Vinayagasundaram
                                        <small>Former-HOD</small></h3><div class=\"clearfix\"></div>
                    <h4>
                                        <em>Currently Working in Computer Center,MIT.</em>
                                    </h4>";                                    
                                    $conn->close();
                                    ?>                                 
                                    <p>
...
echo"<br><br><br><br><br><br><br><br><br><br><br><br><br>";
                                ...
                                $sql=" SELECT * from `Index_check` where FID='$en'";
                                    ...
                                    ?>
                                  <br><br><div align="center">                               <p> <i> Details Mentioned in the profile may not be up to date . Please check for other valid sources.</i> </p> 
                            </div></div>
