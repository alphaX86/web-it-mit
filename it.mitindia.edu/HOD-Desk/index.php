...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description" content="Head of the Department ,Department of Information Technology , Madras Institue Of Technology ,Anna University">
                    ...
                    <div class="row">
                            ...
                            <div class="visible-lg">
                                <ul id="hornavmenu" class="nav navbar-nav">
                                    ...
                                    <li>
                                        <a href="#" class="fa-user">HOD's DESK</a>
                                    </li>
                                    <li>
            ...
            <div id="content">
                <div class="container background-white">
                    <div class="row margin-vert-30">
                        <!-- Main Column -->
                        <div class="col-md-12">
                            <h2 style="color:#00695c; font-size:25pt;">HOD's Desk</h2>
                            <div class="col-md-5">
                                 <img class="margin-bottom-20" src="../assets/img/pics/hoddesk.jpg" alt="image1">
                             </div><br>
                             <p class="animate fadeInRight"style="color:#212121; font-size:12pt;"><b>Dr. Dhananjay Kumar,</b></p>
                             <p class="animate fadeInRight"style="color:#212121; font-size:12pt;">Head , Department of Information Technology,</p>
                             <p class="animate fadeInRight"style="color:#212121; font-size:12pt;">Madras Institue of Technology campus,</p>
                             <p class="animate fadeInRight"style="color:#212121; font-size:12pt;">Anna University, Chennai.</p><br><br><br><br><br><br>
                            <p align="justify" style="color:#212121; font-size:12pt;">Information technology, one of the fastest growing technologies, has become a strategic function in every organization and lands its foot in every walk of our life.  The department  of Information Technology established in the year 2000, offers under graduate and post graduate programmes  in  Information Technology, with the curriculum been devised  and periodically  being revised with the possibility of exploring different forms of knowledge  through theoretical, practical  and productive means as  stated by the  great philosopher Aristotle. </p>
                            <p align="justify"style="color:#212121; font-size:12pt;">The department considers the committed and dedicated faculty as its core strength in providing value education with professional standards to the enthusiastic and vibrant student community. Improved methods of teaching and learning process are adopted to achieve learning abilities through practice, exposure and motivation. Department has good infrastructural and computing facilities and provides a conducive environment to promote academic and research excellence in the department by successfully procuring and executing funded research projects.</p>
                            <p align="justify" style="color:#212121; font-size:12pt;">The department of Information Technology has received funding from the Department of Science and Technology under FIST (Fund for Improvement of Science and Technology) scheme for setting up wireless sensor network and cloud computing labs. The department has also received fund from UGC-DRS-SAP( Department Research Support for Special Assistance Programme) to carry out the research projects in Pervasive Computing.</p>
                            <p align="justify"style="color:#212121; font-size:12pt;">The department endeavors to continually improve, for standing ever competent in producing information technologists in the real sense, through committed and well defined function processes in the department.</p>
                        </div>
                        <!-- End Main Column -->
                    </div>
                </div>
