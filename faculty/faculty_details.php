...
function setClass(els, className, fnName) {
    ...
    <body>
                                ...
                                <?php
                                  ...
                                  echo "<div class=\"pad col-md-6 animate fadeIn\"><img class='img' src=\"../assets/img/pics/".$en.".jpg\" alt=".$row["NAME"]." class=\"margin-top-10\"></div><div class=\"col-md-6 margin-bottom-10 animate fadeInRight\">";                                 
                                    ...
                                    {                  $link_address = $row["FIS"];
                                      ...
                                      if($en=='ITF16'){
                                        echo "<tr><td><p>Experience:</p></td><td><p> 10 Years</p></td></tr>";
                                        echo "<tr><td><p>Home :</p></td><td><p><a href='https://sites.google.com/view/vivekacm/home'>https://sites.google.com/view/vivekacm/home</a></p></td></tr>";
		 echo "<tr><td><p>Bio :</p></td><td><p><a href='https://sites.google.com/view/vivekacm/about'>https://sites.google.com/view/vivekacm/about</a></p></td></tr>";
                                        echo "<tr><td><p>Research Profile:</p></td><td><p><a href='https://orcid.org/0000-0002-1438-4063'>https://orcid.org/0000-0002-1438-4063</a></p></td></tr>";
		echo "<tr><td><p>Subjects Handled:</p></td><td><p><a href='https://sites.google.com/view/vivekacm/teaching-profile'>https://sites.google.com/view/vivekacm/teaching-profile</a></p></td></tr>";
		   echo "<tr><td><p>Email:</p></td><td><p><a href='vivek.acm@mitindia.edu'>vivek.acm@mitindia.edu</a><p></td></tr>";
                                      }else{
		...
		echo "<tr><td><p>Area of Specialisation:</p></td><td><p>" .$row["AREA OF SPECIALISATION"]. "</p></td></tr>";
                                      ...
                                      if($en=="ITF07")
                                      {echo "<tr><td><p>Personal Profile:</p></td><td><p>" ."<a href="."https://sites.google.com/view/grajesh"." target='_blank'>https://sites.google.com/view/grajesh</a> ". "</p></td></tr>";}
                                      if($en=="ITF03")
                                      {
                                          echo "<tr><td><p>Personal Profile:</p></td><td><p>" ."<a href="."https://sites.google.com/site/dhananjayks/home"." target='_blank'>https://sites.google.com/site/dhananjayks/home</a> ". "</p></td></tr>";
                                      }
                                      if($en=="ITF11"){
                                        echo "<tr><td><p>Personal Profile:</p></td><td><p>" ."<a href="."https://sites.google.com/view/dsangeetha/home"." target='_blank'>https://sites.google.com/view/dsangeetha/home</a> ". "</p></td></tr>";  
                                      }
		if($en=='ITF16'){
			echo "<tr><td><p>  <a href=".$link_address." target='_blank'>[AUKDC Profile]</a>                     </p</td></tr>";
		}else{
                                        echo "<tr><td><p>  <a href=".$link_address." target='_blank'>FIS@AU</a>                     </p</td></tr>";
		}
