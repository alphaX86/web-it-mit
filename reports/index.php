...
<html lang="en">
    ...
    <head>
        <!-- Title -->
        <title>Annual Reports - Department Of Information Technology</title>
        <!-- Meta -->
        <meta http-equiv="content-type" content="text/html; charset=utf-8" />
        <meta name="description" content="Annual Reports of Department of Information Technology , Madras Institue Of Technology ,Anna University">
...
?>
    ...
    <body>
		...
		<li>
                                        <a href="../visionMission" class="fa-university">VISION</a>
                                    </li>
            ...
            < <div id="content">
                <div class="container background-white">
                    <div class="row margin-vert-30">
                        <!-- Main Column -->
                        <div class="col-md-12">
                            <h2 style="color:#00695c; font-size:25pt;">ANNUAL REPORT</h2>
                            <p><a href="../assets/pdf/annual report 2016-17_DoIT.docx" target="_blank"style="font-size:12pt;">Annual Report - (2016 - 2017)</a> </p>
